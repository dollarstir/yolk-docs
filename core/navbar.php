...
class Navbar
{
    ...
    {
        $tag = '<nav class="navbar navbar-expand-lg navbar-dark bg-dark" '.$attributes.' style="background-color:rgb(26, 29, 42)!important;">
    ...
    public static function sbar()
    {
      ...
      <div class="dropdown-container">
        <a href="documentation/accordion">Acordion</a>
